  ...
  return (
    <footer className="py-6 dark:bg-gray-800 dark:text-gray-50">
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="md:grid hidden grid-cols-5">
          <div className="pb-6 md:pb-0 col-span-2">
            <a
            ...
            <p className="w-10/12 mt-5">
              ...
              nostrum veniam molestiae facere architecto velit rem nihil! Nam,
              autem? Ipsa ad sequi cupiditate aspernatur blanditiis magnam sed
              nesciunt delectus porro adipisci vel, possimus officia accusamus
              quasi dolores a error neque aliquam aliquid. Sapiente voluptates
              quis saepe corporis aspernatur a dicta illum ratione impedit
              praesentium odio fugiat omnis quasi laborum rerum nulla minus
              aliquam iusto, deleniti ut cum dolorum sit ipsum ipsa? Facere,
              assumenda quibusdam.
            </p>
          </div>
          ...
          <div className=" text-center md:text-left mt-5">
            <div>
              ...
              <p className="my-6">blueskytechcompany@gmail.com</p>
            </div>
            <div className="flex flex-col justify-start pt-6 lg:pt-0">
        ...
        <div className="md:hidden block">
          <Accordion>
            ...
            <AccordionItem
              ...
              className="-mb-5"
            >
              <p className="mb-6">Got Question? Call us 24/7</p>
              <p className="my-6 text-3xl text-violet-500 font-semibold">
                +555-1900-2628
              </p>
              <p className="my-6">
